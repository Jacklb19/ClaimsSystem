...
export default function RegisterAgentPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      const response = await authApi.registerAgent({ username, password })

      toast.success("Agent account created successfully! You can now log in.")
      router.push("/login")
    } catch (error: any) {
    ...
    <div className="min-h-screen flex items-center justify-center">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Enter information to create a new agent account</CardDescription>
        </CardHeader>
        <CardContent>
